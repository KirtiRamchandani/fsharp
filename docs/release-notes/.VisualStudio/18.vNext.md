...
* Fix IntelliSense not suggesting later named arguments after the first one is autocompleted, for methods (including overloads such as `Task.Factory.StartNew`) and optional arguments. ([Issue #19906](https://github.com/dotnet/fsharp/issues/19906), [PR #19940](https://github.com/dotnet/fsharp/pull/19940))
